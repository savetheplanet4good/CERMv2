...
def params():
    ...
    st.markdown(generate_info_icon_class(30, 120,0), unsafe_allow_html=True)
    ...
    st.sidebar.markdown( """ 
                                ...
                                <span class="info-icon30-120-0" data-info="An optional parameter that adjusts the probability of default associated with credit ratings by a percentage of the standard deviation of climate risks, i.e., A value of -50% assumes the cost of climate change increases faster than expected by 50% of the climate change uncertainty. "></span>
