...
def params():
    ...
    st.markdown(generate_info_icon_class(-90, 160,-20), unsafe_allow_html=True)
    ...
    st.sidebar.markdown(f"""
        <p style="font-size:11px; color:#898A8B; margin-top:-20px;">
            <span class="info-icon-90-160--20" data-info="Stochastic increase of physical risk expressed as a percentage of the standard deviation of economic risk ,i.e., A value of 10% means, each year, the annual rise of costs due to climate change randomly speeds up or slows down by an amount equivalent to 10% of a typical economic crisis."></span>
        </p>
    """, unsafe_allow_html=True)
